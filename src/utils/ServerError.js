 ...
 * @typedef { 'ResourceNotFound' | 'InvalidCredentials' | 'MissingFields' | 'Overloaded' | 'Unknown' | 'InvalidDataSent' | 'UniqueDataRepeated' | 'JWTLeft' | 'InvalidJWT' | 'PermissionDenied' | 'Query' | 'Internal' | 'Conflict'} ErrorType
 */
